...
<body>
    <form method="POST">
        ...
        <input type="radio" name="jenisk" value="Laki-Laki" <?php if (isset($_POST["jenisk"]) && $_POST["jenisk"] == "Laki-Laki") { echo "checked"; } ?>> Laki-Laki<br>
        <input type="radio" name="jenisk" value="Perempuan" <?php if (isset($_POST["jenisk"]) && $_POST["jenisk"] == "Perempuan") { echo "checked"; } ?>> Perempuan<br>
